...
const STEPS = [
  ...
  },
  {
    ...
    description:
      "It turns your ideal profiles into search strategies, finds people based on what they actually post, scores each match from 0\u2013100, filters bots and spam, and keeps running in the background. New matches are surfaced every day.",
