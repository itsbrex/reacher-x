...
const [result1, result2, result3] = await Promise.all([
  openrouter
    .callModel({ model: "openai/gpt-5-nano", input: "Question 1" })
    .getText(),
  openrouter
    .callModel({ model: "openai/gpt-5-nano", input: "Question 2" })
    .getText(),
  openrouter
    .callModel({ model: "openai/gpt-5-nano", input: "Question 3" })
    .getText(),
]);
```
