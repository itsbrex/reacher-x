...
whether <code>reasoning.max_tokens</code> (via <code>thinking_budget</code>) is available.
</Note>
...
2. **`message.reasoning_details`** (array): Pass the full reasoning_details block
