...
canonical-url: '[https://openrouter.ai/docs/guides/features/broadcast](https://openrouter.ai/docs/guides/features/broadcast)'
...
type: url
value: >-
[https://openrouter.ai/dynamic-og?title=Broadcast\&description=Send%20traces%20to%20observability%20platforms](https://openrouter.ai/dynamic-og?title=Broadcast&description=Send%20traces%20to%20observability%20platforms)
'og:image:width': 1200
'og:image:height': 630
...
{/_ When updating this list, sync with getPublicDestinationMetadata() in packages/broadcast/registry.ts
which filters by isActive && releaseStatus === 'stable'. See destination metadata in packages/broadcast/destinations/_.ts \*/}
