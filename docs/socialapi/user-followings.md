# Get User Following List - API Reference | SocialAPI

# Get User Following List - API Reference
...
GET https://api.socialapi.me/twitter/friends/list?user\_id={user\_id}
...
- [curl](#tab-panel-237)
- [JavaScript](#tab-panel-238)
- [Python](#tab-panel-239)
- [PHP](#tab-panel-240)

Terminal window

```
curl "https://api.socialapi.me/twitter/friends/list?user_id=44196397" \    -H 'Authorization: Bearer API_KEY' \    -H 'Accept: application/json'
```

```
const userId = '44196397';const API_KEY = 'YOUR_API_KEY_HERE';
fetch(`https://api.socialapi.me/twitter/friends/list?user_id=${userId}`, {    method: 'GET',    headers: {        'Authorization': `Bearer ${API_KEY}`,        'Accept': 'application/json'    }}).then(response => response.json()).then(response => console.log(response)).catch(err => console.error(err));
```

```
import requests
userId = '44196397'API_KEY = 'YOUR_API_KEY_HERE'
url = f'https://api.socialapi.me/twitter/friends/list?user_id={userId}'
...
```
$userId = '44196397';$API_KEY = 'YOUR_API_KEY_HERE';
$url = "https://api.socialapi.me/twitter/friends/list?user_id={$userId}";
$ch = curl_init();
