...
```yaml post /2/media/upload/initialize
openapi: 3.0.0
info:
...
components:
  schemas:
    ...
    MediaCategory:
      type: string
      description: >-
        A string enum value which identifies a media use-case. This identifier
        is used to enforce use-case specific constraints (e.g. file size, video
