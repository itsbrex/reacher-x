...
paths:
  /2/webhooks/replay:
    post:
      ...
      description: >-
        Creates a replay job to retrieve events from up to the past 24 hours for
        all events delivered or attempted to be delivered to the webhook.
    ...
    WebhookReplayCreateRequest:
      ...
      properties:
        from_date:
          type: string
          description: >-
            The oldest (starting) UTC timestamp (inclusive) from which events
            will be provided, in yyyymmddhhmm format.
          pattern: ^[0-9]{12}$
