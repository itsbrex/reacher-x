...
/**
 * Injects the YouTube-style Media Chrome theme template into the DOM.
 * This component should be rendered once at the app root so that
 * any `MediaTheme` can reference `template="media-theme-yt"`.
 */
