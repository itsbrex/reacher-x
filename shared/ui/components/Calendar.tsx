...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        "group/calendar bg-background p-3 [--cell-size:2rem] in-data-[slot=card-content]:bg-transparent",
      ...
      classNames={{
        ...
        dropdown_root: cn(
          "hover:bg-accent has-focus:ring-ring/50 has-focus:ring-[3px] relative rounded-md",
