        ...
        >
          ...
          <div className="col-span-12 self-end lg:mb-12 portrait:md:col-span-12 landscape:md:col-span-3">
            <hgroup className="mt-4 space-y-2">
              ...
              <p className="text-base font-medium text-muted-foreground md:text-2xl">
                Toggle{" "}
                <span className="text-foreground">Exact Phrase Match ON</span>{" "}
                for precise, targeted results. Toggle it{" "}
        ...
        >
          <div className="col-span-12 self-end lg:mb-12 portrait:md:col-span-12 landscape:md:col-span-3">
            <hgroup className="mt-4 space-y-2">
              ...
              <p className="text-base font-medium text-muted-foreground md:text-2xl">
                Reply{" "}
                <span className="text-foreground">directly with ReacherX</span>{" "}
                to reach people fast and offer solutions. Keep replying while
                earlier replies are sending
            ...
            <div className="order-1 mt-0 md:order-2 md:mt-4">
              <hgroup className="space-y-2">
                ...
                <p className="text-base font-medium text-muted-foreground">
                  ...
                  <span className="text-foreground">different ways</span> to
                  find people faster.
                </p>
              </hgroup>
              <Button variant="outline" className="mt-4">
          ...
          <div className="md:flex md:flex-col">
            <div className="order-1 mt-0 md:order-2 md:mt-4">
              <hgroup className="space-y-2">
                ...
                <p className="text-base font-medium text-muted-foreground">
                  Thumbs up{" "}
                  <span className="text-foreground">good results</span> to teach
                  the system what works for you. Thumbs down{" "}
                  <span className="text-foreground">bad ones</span> to get
                  better suggestions.
                </p>
              </hgroup>
              <Button variant="outline" className="mt-4">
